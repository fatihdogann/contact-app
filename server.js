...
// Sunucu başlatma (veritabanı senkronizasyonu olmadan)
// Veritabanı senkronizasyonu önemli ama uygulamanın çalışması için şart değil
const startServer = async () => {
  try {
    ...
    console.log('Uygulama veritabanı olmadan çalışmaya devam ediyor...');
  }
